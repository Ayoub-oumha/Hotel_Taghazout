...
function Login() {
  ...
  const validate = () => {
    ...
    if(!inputs.password || inputs.password.length < 8) {
      newErrors.password = 'Mot de passe requis and 8 caractères minimum';
    }
    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-[#7C6A46] flex-col justify-center items-center p-12 text-white">
        <div className="max-w-md">
          ...
          <p className="text-xl mb-8">Experience luxury and comfort in the heart of Taghazout.</p>
          <div className="h-1 w-20 bg-white rounded-full mb-8"></div>
          <p className="text-sm opacity-80">
            Sign in to access your account and manage your bookings, view special offers, and enjoy a personalized experience.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="font-medium text-[#7C6A46] hover:text-[#907c52]">
                Sign up
              </Link>
            </p>
          </div>
